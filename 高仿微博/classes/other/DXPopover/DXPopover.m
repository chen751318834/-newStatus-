...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.betweenAtViewAndArrowHeight =25.0;
...
- (void)setApplyShadow:(BOOL)applyShadow
{
    ...
    if (_applyShadow) {
        self.layer.shadowColor = [UIColor colorWithRed:0.067 green:0.200 blue:0.200 alpha:0.900].CGColor;
...
- (void)_setup
{
    ...
    switch (self.popoverPosition) {
        ...
        case DXPopoverPositionUp: {
            ...
            anchorPoint = CGPointMake(arrowPoint.x/CGRectGetWidth(frame), 6);
        }
            break;
    }
